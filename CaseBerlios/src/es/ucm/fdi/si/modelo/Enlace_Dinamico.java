 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Enlace_Dinamico extends ConexionEnlace {

	public Enlace_Dinamico(Nodo nodoInicio, Nodo nodoFin, List listaPuntos) {
		super("Enlace_Dinamico "+nodoInicio.toString()+" "+nodoFin.toString(), nodoInicio, nodoFin, listaPuntos);
	}
    ...
    public String toString() {
        return "Enlace_Dinamico "+nodoInicio.toString()+" "+nodoFin.toString();
