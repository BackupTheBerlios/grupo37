 ...
 */
public class ControladorActivadorNexo implements ActionListener {
    private ICase fachada;
    
    public ControladorActivadorNexo(ICase fachada) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        fachada.setTipoSeleccionadoDiseño(Elemento.ACTIVADOR_NEXO);
    }
