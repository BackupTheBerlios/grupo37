 ...
 */
public class ControladorConexionSincro implements ActionListener {
    private ICase fachada;
    
    public ControladorConexionSincro(ICase fachada) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        fachada.setTipoSeleccionadoDiseño(Elemento.CONEXION_SINCRO);
