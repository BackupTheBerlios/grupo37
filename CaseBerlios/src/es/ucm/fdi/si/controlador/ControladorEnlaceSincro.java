 ...
 */
public class ControladorEnlaceSincro implements ActionListener {
    private ICase fachada;
    
    public ControladorEnlaceSincro(ICase fachada) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        fachada.setTipoSeleccionadoDiseño(Elemento.ENLACE_SINCRO);
